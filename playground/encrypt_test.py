...
BEGIN
  ...
  EXECUTE IMMEDIATE '''
    CREATE OR REPLACE TABLE `fathur-project-488913.l2_fathur.dummy_users_100k_encrypted_py` AS
    SELECT
      d.user_id,
      ...
      d.created_at
    FROM `fathur-project-488913.l2_fathur.dummy_users_100k` d
...
print("Encryption via Scripting completed successfully.")